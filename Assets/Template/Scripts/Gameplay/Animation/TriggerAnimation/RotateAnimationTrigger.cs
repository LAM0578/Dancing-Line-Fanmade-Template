...
{
	public class RotateAnimationTrigger : TriggerAnimationComponentBase<Transform>
	{
		[Space]
...
#if UNITY_EDITOR
	[CustomEditor(typeof(RotateAnimationTrigger))]
	public class RotateAnimationTriggerEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			base.OnInspectorGUI();

			var item = (RotateAnimationTrigger)target;
