...
{
	public class MoveAnimationTrigger : TriggerAnimationComponentBase<Transform>
	{
		[Space]
...
#if UNITY_EDITOR
	[CustomEditor(typeof(MoveAnimationTrigger))]
	public class MoveAnimationTriggerEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			base.OnInspectorGUI();

			var item = (MoveAnimationTrigger)target;
